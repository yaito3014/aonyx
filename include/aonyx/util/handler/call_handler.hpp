...
namespace aonyx
{
    namespace util
    {
        ...
        void call_handler(Fn fn, const http::request &req, http::response &res, const inner_handler_params_t params, std::index_sequence<I...>)
        {
            return call_handler_impl<
                Fn,
        ...
        template <class Fn>
        void call_handler(Fn fn, const http::request &req, http::response &res, const inner_handler_params_t params)
        {
            return call_handler(
                fn,
                req,
